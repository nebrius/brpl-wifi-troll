  ...
  return (
    <>
      ...
      <form className={styles.form} onSubmit={onSubmit}>
        ...
        <div className={styles.formRow}>
          <label htmlFor="art">
            Which art piece in Deep Playa is your favorite and why? Please
            answer in 1,000 characters or more.
          </label>
          <textarea
            id="art"
            name="art"
        ...
        <div className={styles.formRow}>
          ...
          <div>
            ...
            <label htmlFor="like-this-2">
              ...
              style due to my childhood which causes me to push people away and
              freak out when anyone tries to get close to me and that&apos;s why
              I&apos;m alone
            </label>
          </div>
          <div>
            ...
            <label htmlFor="like-this-3">
              ...
              style due to my childhood which causes me to pull people too close
              and freak out when they try and exhibit any autonomy and
          ...
          <div>
            ...
            <label htmlFor="like-this-4">
              ...
              everyone is caught up in the bullshit in their lives and refuses
